      ...
      <div class="container gal-container">
	   <div class="row">
		...
		<?php elseif($data['f_has'] === true): ?> 
		  ...
		  <?php if($data['f_projects_has_completed'] === false): ?> 
		 ...
		 <?php elseif($data['f_projects_has_completed'] === true): ?> 
		
	   
			<?php foreach($data['f_projects_completed'] as $row) { ?>	
				 ...
				 <div class="project-box">
				  ...
				  <div class="project-bid">
				   <div class="project-bid-inner">
					<a href="<?=$this->siteUrl()?>/<?=$this->freelancer_url()?>/addrating/<?=e($row["projectid"])?>" class="kafe-btn kafe-btn-yellow"> <i class="fa fa-star"></i> <?=$this->lang('rate')?> <?=$this->client_name()?></a>
				   </div>
				  </div><!--/ .project-bid -->	
				 </div><!--/ .project-box -->	
