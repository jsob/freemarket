	   ...
	   <div class="row">
		<div class="col-lg-12">
         ...
         <div class="headline">
		  ...
		  <a href="<?=$this->siteUrl()?>/<?=$this->client_url()?>/addfiles"><?=$this->lang('add_files')?></a>
		 </div>	
			  ...
			  <?php } }?> 
				  ...
				  <div class="proposal-bid">
				   <div class="proposal-bid-inner">
					 <a href="<?=$this->siteUrl()?>/<?=$this->client_url()?>/download/<?=e($row["id"])?>" class="kafe-btn kafe-btn-yellow"><i class="fa fa-download"></i> <?=$this->lang('download')?></a>
				   </div>
				  </div><!--/ .proposal-bid -->
			 </div><!--/ .proposal-box -->	
