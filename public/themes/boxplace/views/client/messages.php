			 ...
			 <div class="proposal-box">
			  ...
			  <div class="proposal-bid">
			   <div class="proposal-bid-inner">
				<a href="<?=$this->siteUrl()?>/<?=$this->client_url()?>/chat/view/<?=e($row["freelancerid"])?>/<?=e($row["cid"])?>" class="kafe-btn kafe-btn-yellow"><?=$this->lang('click_to_open_chat')?> <i class="fa fa-arrow-right"></i></a>
			   </div>
			  </div><!--/ .proposal-bid -->
			 </div><!--/ .proposal-box -->	
