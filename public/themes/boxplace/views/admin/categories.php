                  ...
                  <table id="example1" class="table table-bordered table-striped">
				    ...
				    <?php
					    ...
					    echo '<td>
					      ...
					      <a id="delete_category" data-id="' . e($row["id"]) . '" class="btn btn-danger btn-xs" data-toggle="tooltip" title="'. $this->lang('delete') .'"><span class="fa fa-trash"></span></a>
		...
		swal({
		  ...
		  dangerMode: true,
			  ...
			  if (willDelete) {    
			     ...
			     $.ajax({
			   		url: '<?=$this->siteUrl()?>/requests/delete_category',
			    	type: 'GET',
